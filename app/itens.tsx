...
import { useRouter } from 'expo-router';
  ...
  const NEW_MOCK_ITEMS: Item[] = [
    { id: '1', name: 'Lingote de Perolânio', description: 'Lingote feito de pérolas comprimidas pela pressão da Endstone, criando um material tão duro quanto titânio que perdeu suas propriedades de teletransporte.', imageName: 'lingote-de-perolânio' },
    ...
    { id: '23', name: 'Molde de Ferraria para Melhoria de Perolânio Reforçado', description: 'Molde avançado para criação de equipamentos de Perolânio Reforçado.', imageName: 'molde-de-ferraria-para-melhoria-de-perolânio-reforçado' },
    { id: '24', name: 'Bloco Perolado', description: 'Bloco decorativo que mantém o brilho característico das pérolas originais do Perolânio.', imageName: 'bloco-perolado' },
    { id: '25', name: 'Bloco de Perolânio', description: 'Bloco de construção feito de Perolânio, combinando belleza residual com extrema resistência.', imageName: 'bloco-de-perolânio' },
  ];
